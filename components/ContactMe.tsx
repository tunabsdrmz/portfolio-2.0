...
export default function ContactMe({pageInfo}: Props) {
    ...
    const onSubmit: SubmitHandler<Inputs> = (formData) => {
        window.location.href = `mailto:tunabosdurmaz2002@gmail.com?subject=${formData.subject}&body=Hi, my name is ${formData.name}. ${formData.message}`
    };
     ...
     mx-auto items-center'>
       ...
       <div className='flex flex-col space-y-3 mt-5'>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col space-y-2 mx-auto '>
            <div className='flex space-x-2 justify-evenly mx-auto '>
